            ...
            $output .= ' 
                ...
                <div style="background-color: white; margin-top: 100px; margin-right:20px !important;margin-left:20px !important;margin-bottom:-50px;padding: 10px;width: 1400px;">
                    <div style="display: flex">
                        <img src="uploads/'.$post->image.'" style="margin:15px;" alt="house image" width="200px" height="200px">

                        <div style="display: flex; font-size:20px;flex-direction: column; height: 200px;justify-content: space-evenly;">
